...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------------+--------+-----------+-----------|                    |--------------+-------------+--------+--------+--------+-----------------|
      KC_LSFT, KC_CAPS,    RALT(KC_6),    KC_5, RALT(KC_4), RALT(KC_5),                      RALT(KC_MINS), RALT(KC_EQL), KC_MINS, KC_LBRC, KC_RBRC,          KC_PEQL,
  //|--------+--------+--------------+--------+-----------+-----------|                    |--------------+-------------+--------+--------+--------+-----------------|
      KC_LCTL, KC_NUHS, LSFT(KC_NUHS), MS_BTN1,      MS_UP,    MS_LEFT,                            MS_RGHT,      MS_DOWN, MS_BTN2, KC_QUOT, KC_NUHS, TD(TD_LALT_RALT),
  //|--------+--------+--------------+--------+-----------+-----------+-------|   |--------+--------------+-------------+--------+--------+--------+-----------------|
